...
export const ThreadList: FC = () => {
  return (
    <ThreadListPrimitive.Root className="flex flex-col w-[200px] bg-slate-50 p-2 shadow-md h-full">
      <ThreadListNew />
      <ThreadListItems />
...
const ThreadListNew: FC = () => {
  return (
    <ThreadListPrimitive.New asChild>
      <Button className="data-[active]:bg-muted hover:bg-muted flex items-center justify-start gap-1 rounded-lg ml-10 px-2.5 py-2 text-start" variant="ghost">
        New Thread
        <PlusIcon />
      </Button>
